      ...
      <div className="row d-flex align-items-center" id="home">
        <div className="col-md-6 col-12 mb-4">
          <div className="text-center">
            ...
            <button className="btn btn-dark px-3 py-2 mt-3 mx-2"><a href="#aboutme" className="text-white text-decoration-none"><span className="h5 hfw-bold">About</span></a></button>
